...
if (!isset($_POST['felh_id']) || !isset($_POST['jogosultsag_id'])) {
    echo json_encode([
        'status' => 'error',
...
$jogosultsag_id = $_POST['jogosultsag_id'];





$update_query = "UPDATE `SYS_felh` SET `jogosultsag_id` = $jogosultsag_id WHERE `felh_id` = $felh_id";
...
if ($jog_modositas) {
    ...
    echo json_encode([
        'status' => 'error',
        'message' => 'Hiba történt a jogosultság módosítása során!'
    ]);
}
